                    ...
                    bottomTitles: AxisTitles(
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (v, m) => Padding(
                          ...
                          child: Text('D${v.toInt()}', style: const TextStyle(fontSize: 11)),
                        ),
                      ),
                    ),
                  ...
                  lineBarsData: [
                    for (final entry in vehicles.asMap().entries)
                      LineChartBarData(
                        ...
                        spots: List.generate(12, (i) => FlSpot(i.toDouble(), (i * 1.5 + (entry.key + 1) * 1.8).toDouble())),
                      ),
                  ],
                ...
                LineChartData(
                  ...
                  lineBarsData: [
                    LineChartBarData(
                      ...
                      barWidth: 3,
                      dotData: const FlDotData(show: false),
                      spots: List.generate(10, (i) => FlSpot(i.toDouble(), 100 + i * 50 + (i % 3) * 30)),
