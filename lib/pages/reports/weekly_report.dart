                    ...
                    bottomTitles: AxisTitles(
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (v, m) => Padding(
                          ...
                          child: Text('W${v.toInt()}', style: const TextStyle(fontSize: 11)),
                        ),
                      ),
                    ),
                  ...
                  lineBarsData: [
                    for (final entry in vehicles.asMap().entries)
                      LineChartBarData(
                        ...
                        spots: List.generate(4, (i) => FlSpot(i.toDouble(), (i * 8 + (entry.key + 1) * 10).toDouble())),
                      ),
                  ],
                ...
                LineChartData(
                  ...
                  lineBarsData: [
                    LineChartBarData(
                      ...
                      barWidth: 3,
                      dotData: const FlDotData(show: false),
                      spots: List.generate(4, (i) => FlSpot(i.toDouble(), 500 + i * 200 + (i % 2) * 100)),
